    ...
    # if message.from_user.id == ADMIN_ID:
        ...
        for ticker in tickers:
            ...
            if data1_open > 0 and data1_close > 0 and data1_low > 0 and data1_high > 0:
                ...
                print(data_check)
                await quick_commands.add_user(1, str(data1_open), 'null')
                await quick_commands.add_user(2, str(data1_close), 'null')
                await quick_commands.add_user(3, str(data1_high), 'null')
                await quick_commands.add_user(4, str(data1_low), 'null')
...
async def main():
    ...
    aioschedule.every(4).seconds.do(db_test)
    while True:
